...
class ResourceTemplateUtil{
    ...
    companion object {
        ...
        fun getHttpVerbs(args: Array<Boolean>) : List<HttpVerb> = arrayHttpVerbs.filterIndexed{ index, _ -> args[index] }

        fun handle(args: Array<Boolean>) : MutableList<String>{
